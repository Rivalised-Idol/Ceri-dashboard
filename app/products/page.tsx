...
// import { fetchProducts, Product } from '@/app/api/fetchProducts';
...
//         <div
//           className="overflow-x-auto overflow-y-auto max-h-[550px]
//                      scrollbar-thin scrollbar-thumb-slate-700
//                      scrollbar-track-slate-900 hover:scrollbar-thumb-slate-500 transition-colors duration-300"
//         >
...
//                         </Link>
//                         <Link
//                             href={`/orders/${product.product_id}/manage`}
